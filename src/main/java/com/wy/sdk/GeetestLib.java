...
public class GeetestLib {
     ...
     * 验证初始化
     */
    public GeetestLibResult register(String digestmod, Map<String, String> paramMap) throws JSONException {
     ...
     * 构建验证初始化接口返回数据
     */
    private void buildRegisterResult(String origin_challenge, String digestmod) throws JSONException {
